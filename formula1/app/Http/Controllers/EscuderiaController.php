...
class EscuderiaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('escuderias.index')
            ->with('success', 'Escuderia created successfully.');
    }
    ...
    public function update(Request $request, Escuderia $escuderia)
    {
        ...
        return redirect()->route('escuderias.index')
            ->with('success', 'Escuderia updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('escuderias.index')
            ->with('success', 'Escuderia deleted successfully');
    }

    public function agregarEscuderia(Request $peticion){
        $escuderia = new Escuderia();

        $escuderia->nombre = $peticion->nombre;
        $escuderia->nacionalidad = $peticion->nacionalidad;
