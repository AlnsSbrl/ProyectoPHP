...
class ResultadoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('resultado.index', compact('resultados','pilotos','circuitos'))
    ...
    public function create()
    {
        ...
        return view('resultado.create', compact('resultado','pilotos','circuitos'));
    }
...
/*
    public function agregarResultado(Request $peticion){
        $resultado = new Resultado();

        $resultado->circuit_id = $peticion->circuit_id;
        $resultado->numero_piloto = $peticion->numero_piloto;
        $resultado->posicion = $peticion->posicion;
        $resultado->save();
    ...
    public function editarResultado(Request $peticion){

        $idResultado = $peticion->route("id");
